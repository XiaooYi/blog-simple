...
export default function PublishForm({ categories, tags }: { categories: any[], tags: any[] }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <label className="inline-flex items-center mt-3 cursor-pointer">
                ...
                />
                <span className="ml-2 text-white text-sm">直接发布</span>
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {tags.length === 0 && <span className="text-gray-500 text-sm">暂无标签，前去后台配置修改</span>}
            </div>
          </div>
